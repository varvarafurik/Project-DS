...
with st.echo(code_location='below'):
    ...
    st.write('На данной карте представлены все агентства подключенные к системе NIBRS (Национальная система отчетности об инцидентах '
             ...
             'Например, в Пенсельвании находится более 1500 агентств, однако к системой пользуют только 25 агентств. ')
    ...
    #BLOCK3
    st.write('Давайте более подробно изучим статистики в одном из штатов. На карте расположены все агнетства штата Канзас. '
    ...
    st.write('ВВП на душу населния в Канзасе, 2009-2019:')
    ...
    ct.to_sql("Kansas", con=engine)
    engine.execute("SELECT * FROM Kansas ORDER BY 1").fetchall()
